...
const PageHeader: React.FC<PageHeaderProps> = ({ title, description, children }) => (
    <div className="bg-gradient-to-br from-violet-50 to-slate-100 dark:from-slate-800 dark:to-violet-950/30 rounded-2xl shadow-lg ring-1 ring-black/5 dark:ring-white/10 p-8 md:p-12 lg:flex lg:items-center lg:justify-between mb-10 animate-fade-in">
